...
import user15Image from 'assets/img/users/Ojie.jpg';
import user17Image from 'assets/img/users/amaka.jpg';
import user16Image from 'assets/img/users/samuel-aimakhede.jpg';
import user18Image from 'assets/img/users/aliko-dangote.jpg';
import user19Image from 'assets/img/users/mike-adenuga.jpg';
import user20Image from 'assets/img/users/taye.jpg';
import user21Image from 'assets/img/users/james.jpg';
import user22Image from 'assets/img/users/sandra-jonathan.jpg';
import user23Image from 'assets/img/users/richard-m-damijo.jpg';
...
export const userProgressTableData = [
  ...
  {
    avatar: user23Image,
    name: 'Richard M. damijo',
    date: '20 mins ago',
    progress: 50,
  },
  {
    avatar: user6Image,
    name: 'WestWood Victor',
    date: '50 mins ago',
    progress: 25,
  },
];

export const recentTransactionsProgressTableData = [
  {
    avatar: user18Image,
    name: 'Aliko Dangote',
    date: '1 min ago',
